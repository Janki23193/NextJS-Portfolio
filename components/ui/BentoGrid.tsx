...
export const BentoGridItem = ({
  ...
  const handleCopy = () =>{
    navigator.clipboard.writeText('jankirawal93@gmail.com');
    setCopied(true);
  }
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:'linear-gradient(90deg, rgb(2,0,36,1) 0%, rgba(59,59,68,1) 26%, rgba(93,108,111,1) 100%)',
      }}
    >
      <div className= {`${id === 6 && 'flex justify-center'} h-full`}>
         ...
         {id === 6 &&(
          <BackgroundGradientAnimation>
            ...
            items-center justify-center text-white font-bold"></div> */}
          </BackgroundGradientAnimation>
         )}
         <div className={cn(
          ...
          {id === 2 && <GlobeDemo/>}
          {id === 3 && (
            <div className="flex gap-1 lg:gap-4 w-fit absolute -right-1 lg:-right-0">
              <div className="flex flex-col gap-3 lg:gap-6">
                {['React.js', 'Next.js','TypeScript','CSS'].map
                ((item) => (
